...
# Pre-defined configs
##
from robot_lab.assets.tqbot import TQBOT2_CFG  # isort: skip


@configclass
class TQBot2RoughEnvCfg(LocomotionVelocityRoughEnvCfg):
    ...
    def __post_init__(self):
        ...
        if self.__class__.__name__ == "TQBot2RoughEnvCfg":
